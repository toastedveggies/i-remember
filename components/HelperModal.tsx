    ...
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label="Helper card">
      ...
      <div className="absolute inset-x-0 top-0 flex justify-center px-4 py-6 sm:inset-y-10 sm:items-start">
        <div className="w-full max-w-lg overflow-auto rounded-3xl border border-brand-border bg-brand-surface shadow-lg">
          ...
          <div className="p-5">
            <h2 className="text-2xl font-semibold text-brand-text">Samuel may need a little help right now.</h2>
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-start gap-3 rounded-2xl border border-brand-border bg-brand-bg p-4">
                ...
                <div>
                  <div className="text-base font-semibold text-brand-text">Tell him where he is</div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-brand-border bg-brand-bg p-4">
                ...
                <div>
                  <div className="text-base font-semibold text-brand-text">Tell him what time/day it is</div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-brand-border bg-brand-bg p-4">
                ...
                <div>
                  <div className="text-base font-semibold text-brand-text">Help him contact Maria</div>
                  <div className="mt-1 text-base text-brand-muted">A quick call can help reassure him.</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-5 rounded-3xl border border-brand-border bg-brand-support p-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-lg font-semibold text-brand-text">Maria (daughter)</div>
              </div>
